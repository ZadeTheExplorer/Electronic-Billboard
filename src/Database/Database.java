...
public class Database {
    ...
    public static void init() throws FileNotFoundException, SQLException {
        ...
        statement.execute("INSERT INTO billboards VALUES('DenVau Rapper', 'admin', '#FFC9C9', '#FF4900', '#000000', 'https://image.plo.vn/w800/Uploaded/2020/wopsvun/2019_06_20/den-vau_gsuj.jpg', 'Song: 2 Billion Years', 'Directed by Đen\n" +
                "Prod. by paryobeats \n" +
                "Record/Mix/Master: Trac Ngoc Linh\n" +
        ...
        scheduleStatement.setTime(2, Time.valueOf("00:05:30"));
        scheduleStatement.setTime(3, new Time(900000));
        scheduleStatement.executeQuery();

        scheduleStatement.setString(1,"DenVau Rapper");
        scheduleStatement.setString(4, "Wednesday");
        scheduleStatement.setTime(2, Time.valueOf("00:10:00"));
        scheduleStatement.setTime(3, new Time(900000));
        scheduleStatement.executeQuery();
